    ...
    <div className={`min-h-screen font-sans relative overflow-x-hidden ${
        ...
        <div className={`mx-auto flex max-w-7xl items-center justify-between rounded-full border px-4 py-3 sm:px-6 ${
          ...
          <div className="flex items-center gap-3">
            <div className={`flex h-11 w-11 items-center justify-center rounded-2xl ${
              ...
              <SmartImage src={isDarkMode ? "/logo%20SL.png" : "/logo%20SD.jpg"} alt="Spaces logo" className="h-7 w-7 object-contain" loading="eager" fetchPriority="high" />
            </div>
            <div>
      ...
      <footer className={`relative z-10 px-4 py-8 sm:px-6 sm:py-12 ${
        ...
        <div className={`mx-auto flex max-w-7xl flex-col gap-4 border-t pt-6 sm:flex-row sm:items-center sm:justify-between ${
          ...
          <div className="flex items-center gap-3">
            <SmartImage src={isDarkMode ? "/logo%20SL.png" : "/logo%20SD.jpg"} alt="Spaces logo" className="h-8 w-8 rounded-xl object-contain" loading="eager" fetchPriority="high" />
